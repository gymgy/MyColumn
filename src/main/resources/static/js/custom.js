...
$(document).ready(function() {
  ...
  function addRequestMessage(message) {
    ...
    let requestMessageElement = $('<div class="row message-bubble"><img class="chat-icon" th:src="@{images/avatar.png}"><div class="message-text request">' +  escapedMessage + '</div></div>');
    chatWindow.append(requestMessageElement);
    let responseMessageElement = $('<div class="row message-bubble"><img class="chat-icon" th:src="@{images/chatgpt.png}"><div class="message-text response"><span class="loading-icon"><i class="fa fa-spinner fa-pulse fa-2x"></i></span></div></div>');
        ...
        onprogress: function(e) {
          ...
          try{
            ...
            if(resJsonObj.hasOwnProperty("error")){
              ...
              addResponseMessage(res.slice(2,-2));
            }
          }catch(e){
